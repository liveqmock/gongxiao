...
public interface DistributorCashAccountService {
     ...
     * @return
     */
    DistributorCashAccount getDistributorCashAccount(RpcHeader rpcHeader, String currencyCode, long projectId, long distributorId);
     ...
     * @return String 流水号
     */
    String updateDistributorCashAccount(RpcHeader rpcHeader,
