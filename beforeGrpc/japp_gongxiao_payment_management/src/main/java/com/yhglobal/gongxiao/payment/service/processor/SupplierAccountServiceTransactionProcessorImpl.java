...
public class SupplierAccountServiceTransactionProcessorImpl implements SupplierAccountServiceTransactionProcessor {
    ...
    public RpcResult<PurchaseFlowCollections> payForPurchase(RpcHeader rpcHeader, String currencyCode, long projectId, long couponToYh, long couponToAd, long prepaidToYh, long prepaidToAd, String purchaseOrderNo, Date transactionTime) {
        ...
        try {
            ...
            if (couponToAd > 0) {
                try {
                    //上账账户扣款 插入记录
                    String postFlowNo = supplierCouponAccountService.updateSupplierCouponAccount(rpcHeader, currencyCode, projectId, -couponToAd, transactionTime, null, purchaseOrderNo, "Yhglobal");
                    //转账到AD过账账户
                    String transferFlowNo = supplierCouponBufferToDistributorService.updateCouponBufferToDistributorAccount(rpcHeader, currencyCode, projectId, null, null, couponToAd, purchaseOrderNo, transactionTime, null, postFlowNo);
            ...
            if (couponToYh > 0) {
                try {
                    //上账账户冻结金额
                    String flowNo = supplierCouponAccountService.updateSupplierCouponAccount(rpcHeader, currencyCode, projectId, -couponToYh, transactionTime, null, purchaseOrderNo, "Yhglobal");
                    //转账到越海缓冲账户
                    String bufferFlowNo = supplierCouponBufferToYhglobalService.updateCouponBufferToYhglobal(rpcHeader, currencyCode, projectId, couponToYh, purchaseOrderNo, transactionTime, null, flowNo);
            ...
            if (prepaidToAd > 0) {
                try {
                    //上账账户扣款
                    String postFlowNo = supplierPrepaidAccountService.updateSupplierPrepaidAccount(rpcHeader, currencyCode, projectId, -prepaidToAd, transactionTime, null, purchaseOrderNo, "Distributor");
                    //转账到越海缓冲账户
                    String flowNo = supplierPrepaidBufferToDistributorService.updatePrepaidBufferToDistributorAccount(rpcHeader, currencyCode, projectId, null, null, prepaidToAd, purchaseOrderNo, transactionTime, null, postFlowNo);
            ...
            if (prepaidToYh > 0) {
                try {
                    //上账账户冻结金额
                    String flowNo = supplierPrepaidAccountService.updateSupplierPrepaidAccount(rpcHeader, currencyCode, projectId, -prepaidToYh, transactionTime, null, purchaseOrderNo, "Distributor");
                    //转账到越海缓冲账户
                    String bufferFlowNo = supplierPrepaidBufferToYhglobalService.updatePrepaidBufferToYhglobal(rpcHeader, currencyCode, projectId, prepaidToYh, purchaseOrderNo, transactionTime, null, flowNo);
