...
public interface PurchaseOrderMapper extends BaseMapper {
    ...
    int deleteByPrimaryKey(@Param("purchaseOrderId") Long purchaseOrderId);

    @Insert({
            "insert into purchase_order (purchaseOrderId, orderStatus,easStatus, ",
            "purchaseOrderNo, projectId, ",
            "projectName, brandId, ",
            "brandName, supplierId, ",
            "supplierName, warehouseId, ",
            "warehouseName, purchaseType,provinceId, ",
            "provinceName, cityId, ",
            "cityName, districtId, ",
            ...
            "#{warehouseName,jdbcType=VARCHAR},#{purchaseType}, #{provinceId,jdbcType=INTEGER}, ",
    ...
    @Select({
            ...
            "brandName, supplierId, supplierName, warehouseId, warehouseName, provinceId, ",
    ...
    PurchaseOrder selectByPurchaseNo(String purchaseOrderNo);
    ...
    List<PurchaseOrder> selectByBrandOrderNo(@Param("brandOrderNo") String brandOrderNo);
    ...
    PurchaseOrder getByUniqueNumber(@Param("uniqueNumber") String uniqueNumber);
    ...
    List<PurchaseOrder> selectPurchaseOrderListByEasStatus(@Param("easStatus") int easStatus);
    ...
    int updateInboundOrderInfo(@Param("purchaseOrderNo") String purchaseOrderNo,
    ...
    int updateEasInfo(@Param("purchaseOrderNo") String purchaseOrderNo,
    ...
    int updateAlreadyPay(@Param("purchaseOrderNo") String purchaseOrderNo);
    ...
    int updatePurchaseOrderStatus(@Param("purchaseOrderNo") String purchaseOrderNo,
    ...
    int updatePurchaseEasStatus(@Param("purchaseOrderId") long purchaseOrderId,
    ...
    int updateOperateTrace(@Param("purchaseOrderNo") String purchaseOrderNo,
    ...
    int cancelPurchaseOrder(@Param("purchaseOrderNo") String purchaseOrderNo);


    @SelectProvider(type = PurchaseOrderSqlProvider.class, method = "getList")
    List<PurchaseOrder> getPurchaseOrderList(@Param("projectId") String projectId,
