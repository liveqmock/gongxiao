...
public interface SupplierPrepaidTransferToYhglobalFlowMapper extends BaseMapper {
    @Delete({
            "delete from supplier_prepaid_transfer_to_yhglobal_flow",
            "where flowId = #{flowId,jdbcType=BIGINT}"
    })
    int deleteByPrimaryKey(Long flowId);

    @Insert({
            "insert into supplier_prepaid_transfer_to_yhglobal_flow (flowId, flowNo, ",
    ...
    int insert(SupplierPrepaidTransferToYhglobalFlow record);
    ...
    @Select({
            ...
            "from supplier_prepaid_transfer_to_yhglobal_flow",
            "where flowId = #{flowId,jdbcType=BIGINT}"
    })
    SupplierPrepaidTransferToYhglobalFlow selectByPrimaryKey(Long flowId);

    @Update({
            "update supplier_prepaid_transfer_to_yhglobal_flow",
    ...
    int updateByPrimaryKey(SupplierPrepaidTransferToYhglobalFlow record);
}