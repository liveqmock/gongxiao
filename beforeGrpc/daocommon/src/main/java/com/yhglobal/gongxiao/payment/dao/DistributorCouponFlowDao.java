...
public class DistributorCouponFlowDao {
    ...
    public Long selectIncomeAmount(String currencyCode, long distributorId, long projectId, Integer moneyFlow, Date beginDate, Date endDate) {
    ...
    public Long selectExpenditureAmount(String currencyCode, long supplierId, long distributorId, Integer moneyFlow, Date beginDate, Date endDate) {
