package com.yhglobal.gongxiao.payment.record.dao.mapping;
...
public interface YhglobalCouponLedgerWriteoffRecordMapper extends BaseMapper {
    ...
    @Insert({
            ...
            "createdById, createdByName,accountType,projectId,useDate, philipDocumentNo)",
            "values (",
            "#{confirmId}, #{toReceiveCouponId}, ",
            "#{confirmAmount}, #{receiptAmount}, ",
            "#{flowNo}, #{dataVersion}, ",
            ...
            "#{accountType}, #{projectId}, #{useDate}, #{philipDocumentNo})"
    })
