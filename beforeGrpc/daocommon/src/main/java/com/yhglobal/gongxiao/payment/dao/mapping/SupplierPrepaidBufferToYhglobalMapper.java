...
public interface SupplierPrepaidBufferToYhglobalMapper extends BaseMapper {
    ...
    @Insert({
            "insert into supplier_prepaid_buffer_to_yhglobal (supplierId, supplierName, ",
    ...
    int insert(SupplierPrepaidBufferToYhglobal record);
    ...
    @Select({
            ...
            "from supplier_prepaid_buffer_to_yhglobal",
            "where projectId = #{projectId}"
    })
    SupplierPrepaidBufferToYhglobal getAccount( @Param("projectId") long projectId);

    @Update({
            "update supplier_prepaid_buffer_to_yhglobal",
    ...
    int updateByPrimaryKeyWithBLOBs(SupplierPrepaidBufferToYhglobal record);
