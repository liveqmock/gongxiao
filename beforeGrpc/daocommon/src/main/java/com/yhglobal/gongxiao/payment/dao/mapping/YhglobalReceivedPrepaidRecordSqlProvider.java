 ...
 * @author: 葛灿
 */
public class YhglobalReceivedPrepaidRecordSqlProvider {

    public String selectPrepaidReceivedRecords(@Param("currencyCode") String currencyCode,
        ...
        return new SQL() {{
            ...
            FROM("yhglobal_received_prepaid_record");
