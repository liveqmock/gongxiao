            ...
            columns: [{
                ...
                formatter: function (value) {
                    if(!value){
                        ...
                        return '<a class="table-yh-link skipdetail" href="./purchase-detail.html?purchaseOrderNumber=' + value + '">' + value + '</a>';
                    }
                }
            }, {
                ...
                formatter: function (value, row) {
                    var str1 = '<a class="table-yh-link skipreview" href="./purchase-goods.html?purchaseOrderNumber=' + row.purchaseOrderNumber + '&projectName=' + projectName + '&projectId=' + projectId + '&warehouseName=' + row.warehouseName + '&warehouseId=' + row.warehouseId + '&requireInboundDate=' + row.requireInboundDate + '">' + '预约入库  ' + '</a>  ';
                    var str2 = '<a class="table-yh-link skipreview" href="./purchase-edit.html?purchaseOrderNumber=' + row.purchaseOrderNumber + '&projectName=' + projectName + '&projectId=' + projectId + '">' + '编辑 ' + '</a>  ';
                    var str3 = '<a class="table-yh-link skipreview" href="../storage/storage-notice-entrymanagement.html?purchaseOrderNumber=' + row.purchaseOrderNumber + '&projectName=' + projectName + '&projectId=' + projectId + '">' + '  入库单详情' + '</a>  ';
                    var cancelStr = '<a class="table-yh-danger cancel-opera">' + '作废 ' + '</a>  ';
                    ...
                    if (row['enablePlanInStock']) {
                        // statusResult = statusResult + str1;
                        statusResult = [statusResult, str1].join("");
                    }
                    if (row['enableDetail']) {
                        // statusResult = statusResult + str3;
