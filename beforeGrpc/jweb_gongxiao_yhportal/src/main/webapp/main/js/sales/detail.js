    ...
    function salesDetailInit() {
        ...
        $.get(URL + "/sales/orderInfo", {
            ...
            if (res.returnCode === 0) {
                ...
                $("#orderstatus").html(orderData.salesOrderStatusString);
                ...
                $shipmentAmount.html(shipmentAmount);
                ...
                $("#supplieramount").html(orderData.supplierDiscountAmountDouble);
                $("#yhamount").html(orderData.yhDiscountAmountDouble);
