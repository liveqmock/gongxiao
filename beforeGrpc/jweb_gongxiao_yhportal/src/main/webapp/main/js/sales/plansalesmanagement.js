        ...
        $yhTable.bootstrapTable({
            ...
            columns: [{
                ...
                formatter: function (value, row) {
                    if(row['salesPlanNo']){
                        return [
                            // '<a class="repairlink" href="javascript:void(0)">' + '维护' + '</a> ',
                            '<a target="_blank" href="./sales-repair.html?projectId=' + projectId + '&projectName=' + projectName + '&salesPlanNo=' + row.salesPlanNo + '&saleGuidePrice=' + row.saleGuidePrice + '&productCode=' + row.productCode + '&productName=' + row.productName + '&productId=' + row.productId + '">' + '维护' + '</a> ',
                            '<a class="reviselink" href="javascript:void(0)">',
                            '修改',
                            '</a>'
                        ].join('');
                    }else{
