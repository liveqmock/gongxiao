        ...
        $yhTable.bootstrapTable({
            ...
            columns: [{
                ...
                formatter: function(value, row) {
                    if(value){
                        return '<a class="table-yh-link skipreview" href="./storage-outbounddetail.html?gongxiaoOutboundOrderNo=' + row.gongxiaoOutboundOrderNo +'&wmsOutboundOrderNo='+ row.wmsOutboundOrderNo + '&projectId='+projectId+'&projectName='+projectName+'">' + row.gongxiaoOutboundOrderNo + '</a>';
                    }else{
                        return ""
                    }
                }
