        ...
        $storageEntryTable.bootstrapTable({
            ...
            columns: [{
                ...
                formatter: function(value, row) {
                    if(value){
                        return '<a class="table-yh-link skipreview" href="./storage-notice-outbounddetail.html?gongxiaoOutboundOrderNo=' + row.gongxiaoOutboundOrderNo +'&productCode='+ row.productCode + '&projectId='+projectId+'&projectName='+projectName+'&inventoryType='+row.inventoryType+'">' + row.gongxiaoOutboundOrderNo + '</a>';
                    }else{
                        return ""
                    }
                }
                ...
                formatter: function (value, row) {
                    if (row.orderStatus === 0){
                        return '<a class="cancel-submit" href="javascript:void(0)">取消</a>';
                    }else if (row.orderStatus === 1){
                        return '<a class="close-submit" href="javascript:void(0)">关闭</a>';
                    }else {
                        return "";
                    }
