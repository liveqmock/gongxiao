        ...
        $stockquerytable.bootstrapTable({
            ...
            columns: [{
                ...
                formatter: function (value, row) {
                    if(value){
                        return '<a class="table-yh-link skipreview" href="./diaobo-detail.html?allocateNo=' + row.allocateNo + '&projectId=' + projectId +'">' + row.allocateNo + '</a>';
                    }else{
                        return ""
                    }
                }
                ...
                formatter: function (value, row) {
                    if(row['allocateNo']){
                        if (row.status === 0){
                            return '<a class="sight-submit" href="javascript:;">确认调拨</a>'
                        }else{
                            return '<a href="javascript:;">调拨完成</a>'
                        }
                    }else{
                        return ""
                    }
