...
public class PurchaseOrder implements Serializable{
    ...
    private int purchaseType;//0 普通采购  1货补
    ...
    * */
    ...
    public String toString() {
        return "PurchaseOrder{" +
                ...
                ", expectedInboundDate=" + expectedInboundDate +
                ", orderDeadlineDate=" + orderDeadlineDate +
                ", brandOrderNo='" + brandOrderNo + '\'' +
                ", contractReferenceOrderNo='" + contractReferenceOrderNo + '\'' +
                ", remark='" + remark + '\'' +
                ...
                ", estimatedCouponTotalAmount=" + estimatedCouponTotalAmount +
                ...
                ", cashAmountUse=" + cashAmountUse +
                ", couponConfirmReceipt='" + couponConfirmReceipt + '\'' +
                ", prepaidConfirmReceipt='" + prepaidConfirmReceipt + '\'' +
                ", cashConfirmReceipt='" + cashConfirmReceipt + '\'' +
                ", easPurchaseOrderId='" + easPurchaseOrderId + '\'' +
