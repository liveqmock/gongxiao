package com.yhglobal.gongxiao.warehousemanagement.dto.wms.outstock;
...
public class StockOutOrderItem implements Serializable {
    ...
    public StockOutOrderItem(String itemNO, String itemCode, String itemName, int inventoryType, int itemQuantity, double itemPrice, boolean isInsured, double actualPrice, Date produceDate, Date expireDate, String batchCode, String eRPBatchCode) {
        this.itemNO = itemNO;
