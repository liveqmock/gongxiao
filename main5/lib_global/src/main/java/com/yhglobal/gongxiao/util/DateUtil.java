...
public class DateUtil {
    ...
    /**
     * 获取指定个数月份之前的第一天的0时0分0秒
     * @param referDate
     * @return
     */
    public static Date getBeforeSeveralMonthDate(Date referDate, int month){
        if (referDate == null){
            referDate = new Date();
        }
    ...
    public static Long getBeforeYearMonth(Date referDate,int month){
        if (referDate == null){
            referDate = new Date();
        }
        Calendar calendar = Calendar.getInstance();
        ...
        String yearMonthString = sf.format(time);
        long yearMonth = Long.parseLong(yearMonthString);
        return yearMonth;
    }
     ...
     * @return
     */
    public static Date initThisMonth(Date referDate){
        if (referDate == null){
            referDate = new Date();
        }
        Calendar calendar = Calendar.getInstance();
     ...
     * @return
     */
    public static long getYearMonth(Date referDate){
        if (referDate == null){
            referDate = new Date();
        }
        SimpleDateFormat sf = new SimpleDateFormat("yyyyMM");
        String yearMonthString = sf.format(referDate);
        long yearMonth = Long.parseLong(yearMonthString);
