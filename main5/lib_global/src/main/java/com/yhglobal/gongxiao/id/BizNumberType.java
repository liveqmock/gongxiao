...
public enum BizNumberType {
    ...
    STOCK_SOOUT_ORDER_ITEM_NO("销售出单明细单号","SOITOUT"),
    STOCK_OTHER_IN_NO("其他入库单号", "OTIN"),
    STOCK_OTHER_OUT_NO("其他出库单号", "OTOUT"),
    STOCK_TSF_IN_NO("调拨入库单号", "DBIN"),
    STOCK_TSF_OUT_NO("调拨出库单号", "DBOT"),
    OTHER_IN_NO("其他入库","OT"),
    OTHER_OUT_NO("其他出库","OT"),
    STOCK_BATCH_NO("批次号", "PC"),
    TRANSFER_NO("调拨单号","TSF"),

    SALE_PLANE_ORDER_NO("预售单号", "PS"),
    SALE_PLANE_ORDER_ITEM_NO("可售单号", "CS"),
    ...
    YHGLOBAL_GROSS_PROFIT_WRITEROFF_FLOW("越海毛利核销流水", "YGPWF"),
    YHGLOBAL_GROSS_PROFIT_CANCEL_WRITEROFF_FLOW("越海毛利取消核销流水", "YGPCWF"),
