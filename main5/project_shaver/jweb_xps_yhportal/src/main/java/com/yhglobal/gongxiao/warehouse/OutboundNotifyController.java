...
public class OutboundNotifyController {
    ...
    public GongxiaoResult selectWmsOutboundOrder(String projectId, String gongxiaoOutNo, String salesNo, String orderType, String customer, String
        ...
        try {
            ...
            gongxiaoResult = XpsWarehouseManager.selectWmsOutboundOrder(portalConfig.getWarehouseUrl(), WmsSourceChannel.CHANNEL_SHAVER.getChannelId(), channelToken, projectId, gongxiaoOutNo, salesNo, orderType, customer, createTimeBeging, createTimeLast, pageNumber, pageSize);
    ...
    public GongxiaoResult selectOutboundBasicInfo(String projectId, String gongxiaoOutboundOrderNo, String wmsOutboundOrderNo, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            GongxiaoRpc.RpcHeader rpcHeader = RpcHeaderUtil.createRpcHeader(traceId, portalUserInfo.getUserId(), portalUserInfo.getUserName());
            String channelToken = "233564356";
            gongxiaoResult = XpsWarehouseManager.selectWmsByOutboundNum(portalConfig.getWarehouseUrl(), WmsSourceChannel.CHANNEL_SHAVER.getChannelId(), channelToken, projectId, gongxiaoOutboundOrderNo, wmsOutboundOrderNo);
    ...
    public GongxiaoResult selectWmsOutboundOrderItem(String projectId, String gongxiaoOutboundOrderNo, String wmsOutboundOrderNo, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            GongxiaoRpc.RpcHeader rpcHeader = RpcHeaderUtil.createRpcHeader(traceId, portalUserInfo.getUserId(), portalUserInfo.getUserName());
            String channelToken = "233564356";
            gongxiaoResult = XpsWarehouseManager.selectWmsOutboundOrderItem(portalConfig.getWarehouseUrl(), WmsSourceChannel.CHANNEL_SHAVER.getChannelId(), channelToken, projectId, gongxiaoOutboundOrderNo, wmsOutboundOrderNo);
