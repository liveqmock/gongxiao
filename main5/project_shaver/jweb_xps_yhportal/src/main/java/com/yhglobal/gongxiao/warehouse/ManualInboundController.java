...
public class ManualInboundController {
    ...
    public GongxiaoResult insertManualInboundOrder(String projectId,
        ...
        try {
            ...
            gongxiaoResult = XpsWarehouseManager.insertManualInboundOrder(portalConfig.getWarehouseUrl(), WmsSourceChannel.CHANNEL_SHAVER.getChannelId(),channelToken,projectId,warehouseId,warehouseName,recieveAddress,supplierName,businessDate,remark,inboundType,purchaseItemInfoJson);
