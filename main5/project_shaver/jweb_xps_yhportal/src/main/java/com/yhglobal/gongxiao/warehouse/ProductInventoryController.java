...
public class ProductInventoryController {
    ...
    public GongxiaoResult selectProductInventoryInfo(long projectId, String productCode, String productName, int pageNumber, int pageSize, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            gongxiaoResult = XpsWarehouseManager.selectProductInventoryInfo(portalConfig.getWarehouseUrl(), WmsSourceChannel.CHANNEL_SHAVER.getChannelId(), channelToken, String.valueOf(projectId), productCode, productName, pageNumber, pageSize);
    ...
    public GongxiaoResult selecWarehouseInventoryInfo(String projectId, String productCode, String productName, String warehouseId, String batchNo, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            GongxiaoRpc.RpcHeader rpcHeader = RpcHeaderUtil.createRpcHeader(traceId, portalUserInfo.getUserId(), portalUserInfo.getUserName());
            String channelToken = "52123454";
            gongxiaoResult = XpsWarehouseManager.selecWarehouseInventoryInfo(portalConfig.getWarehouseUrl(), WmsSourceChannel.CHANNEL_SHAVER.getChannelId(), channelToken, projectId, productCode, productName, warehouseId, batchNo);
