                    ...
                    },
                    {
                        ...
                        events: {
                            'click .batch-select': function (event, value, row, index) {
                                ...
                                var inventoryStatus = row.inventoryStatus;
        ...
        function submitSalesOrder() {
            ...
            $.each(salesOrderData, function (index, salesItem) {
                itemsInfo[index] = {
                    ...
                    inventoryStatus: salesItem.inventoryStatus,
                    purchaseType: salesItem.purchaseType,
            ...
            var submitParams = {
                ...
                warehouseOutId: $pageElement.$warehouseoutlist.val(),
