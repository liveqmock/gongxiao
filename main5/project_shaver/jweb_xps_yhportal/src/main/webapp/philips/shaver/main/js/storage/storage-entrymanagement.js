        ...
        $yhTable.bootstrapTable({
            ...
            columns: [{
                ...
                formatter: function (value, row) {
                    if(value){
                        return '<a class="table-yh-link" href="./storage-entrydetail.html?gongxiaoInboundOrderNo=' + row.gongxiaoInboundOrderNo + '&wmsInboundOrderNo=' + row.wmsInboundOrderNo + '&projectId=' + projectId + '&projectText=' +projectName+'">' + row.gongxiaoInboundOrderNo + '</a>';
                    }else{
                        return ""
                    }
                }
