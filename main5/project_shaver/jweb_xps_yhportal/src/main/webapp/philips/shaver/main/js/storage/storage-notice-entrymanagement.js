        ...
        $stockquerytable.bootstrapTable({
            ...
            columns: [{
                ...
                formatter: function (value, row) {
                    if(value){
                        return '<a class="table-yh-link" href="./storage-notice-entrydetail.html?gongxiaoInboundOrderNo=' + row.gongxiaoInboundOrderNo + '&projectId=' + projectId + '&projectText=' +projectName+'">' + row.gongxiaoInboundOrderNo + '</a>';
                    }else{
                        return ""
                    }
                }
