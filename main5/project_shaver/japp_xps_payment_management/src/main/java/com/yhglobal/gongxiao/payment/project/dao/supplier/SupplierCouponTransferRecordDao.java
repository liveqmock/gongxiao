...
public class SupplierCouponTransferRecordDao {
    ...
    public Long selectIncomeAmount(String prefix, String currencyCode, long supplierId, long projectId, Integer moneyFlow, Date beginDate, Date endDate) {
    ...
    public Long selectExpenditureAmount(String prefix, String currencyCode, long supplierId, long projectId, Integer moneyFlow, Date beginDate, Date endDate) {
