...
public class SalesOrderInfo implements Serializable {
    ...
    private List<SalesOrderItemInfo> itemList = new ArrayList();


    public List<SalesOrderItemInfo> getItemList() {
        return itemList;
    }

    public void setItemList(List<SalesOrderItemInfo> itemList) {
