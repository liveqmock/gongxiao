package com.yhglobal.gongxiao.transport.util;

public class TransportPortalTraceIdGenerator {
    ...
    public static String genTraceId(String uid, int terminalCode, String portalId, String servletPath) {
        ...
        builder.append(DELIMITER);
        builder.append("YHGW").append(portalId);
        builder.append(DELIMITER);
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(genTraceId("100", 9, "001", "/transport"));
    }
