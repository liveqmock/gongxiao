...
public class YhglobalCouponLedger implements Serializable {
    ...
    private  Date ylPurchaseTime;

    public Date getYlPurchaseTime() {
        return ylPurchaseTime;
    }

    public void setYlPurchaseTime(Date ylPurchaseTime) {
        this.ylPurchaseTime = ylPurchaseTime;
    }
    ...
    public String getConfirmAmountDoubleStr(){
        return NumberFormat.format(this.confirmAmountDouble,"#,##0.00");
    }
    public String getReceiptAmountDoubleStr(){
