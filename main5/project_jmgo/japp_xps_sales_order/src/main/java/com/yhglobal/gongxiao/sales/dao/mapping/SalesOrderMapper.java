...
public interface SalesOrderMapper extends BaseMapper {
    ...
    @Select({
            ...
            "shouldReceiveGrossProfit, receivedGrossProfit, discountAmountJmgo",
    ...
    @Update({
            ...
            "set",
            "salesOrderStatus = #{salesOrderStatus},",
            "discountAmountJmgo = #{discountAmountJmgo},",
            "salesContactNo = #{salesContractNo},",
    ...
    int updateApprovalInfo(@Param("prefix") String prefix,
                           ...
                           @Param("dataVersion") Long dataVersion,
                           @Param("salesOrderStatus") int salesOrderStatus,
                           @Param("discountAmountJmgo") long discountAmountJmgo,
                           @Param("salesContractNo") String salesContractNo,
