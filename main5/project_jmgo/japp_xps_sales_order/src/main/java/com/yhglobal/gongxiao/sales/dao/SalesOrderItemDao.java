...
//    }
     ...
     * @param usedDiscountAmount  使用优惠金额(单价)
     * @return 更新成功条数
     */
    public int updateDiscountAmount(String prefix, Long salesOrderItemId, Long dataVersion, long usedDiscountAmount) {
        return salesOrderItemMapper.updateCouponPrepaidAmount(prefix, salesOrderItemId, dataVersion, usedDiscountAmount);
    }
