...
public class SalesOrderDao {
     ...
     * @param dataVersion        数据版本
     * @param salesOrderStatus   销售单状态
     * @param discountAmountJmgo 坚果优惠基恩
     ...
     * @return 更新成功记录数
     */
    public int updateApprovalInfo(String prefix, Long salesOrderId, Long dataVersion, int salesOrderStatus, long discountAmountJmgo, String salesContractNo, long cashAmount, Date orderCheckTime, String tracelog) {
        return salesOrderMapper.updateApprovalInfo(prefix, salesOrderId, dataVersion, salesOrderStatus, discountAmountJmgo, salesContractNo, cashAmount, orderCheckTime, tracelog);
    }
