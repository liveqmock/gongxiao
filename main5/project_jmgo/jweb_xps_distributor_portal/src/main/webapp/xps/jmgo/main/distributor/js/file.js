...
document.writeln("<script src=\'./js/popup/layer.js\'></script>");
document.writeln("<script src=\'./js/app-57f58a4d2a.js\'></script>");
document.writeln("<script src=\'./js/customer/index.js\'></script>");