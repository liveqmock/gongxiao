...
import com.yhglobal.gongxiao.payment.project.dao.yhglobal.mapping.YhglobalCouponLedgerWriteoffRecordMapper;
...
public class YhglobalCouponWriteoffRecordDao {
    ...
    public int updateRollbackStatus(int isRollback,Long confirmId){
        return yhglobalCouponLedgerWriteoffRecordMapper.updateRollbackStatus(isRollback,confirmId);
    }
