...
public interface YhglobalToReceiveCouponLedgerMapper extends BaseMapper {
   ...
   /* @InsertProvider(type=YhglobalCouponLedgerSqlProvider.class, method="insertSelective")
    ...
    YhglobalCouponLedger selectCouponLedgerForWriteoff(Long purchaseCouponLedgerId);
...
*/
   ...
   int updateByPrimaryKeyWithBLOBs(YhglobalCouponLedger record);
    ...
    @Update({
            ...
            "lastUpdateTime = #{lastUpdateTime,jdbcType=TIMESTAMP},",
            "toBeConfirmAmount = #{toBeConfirmAmount,jdbcType=BIGINT},",
            "tracelog = #{tracelog,jdbcType=LONGVARCHAR}, lastUpdateTime = #{lastUpdateTime, jdbcType=TIMESTAMP}",
            "where purchaseCouponLedgerId = #{purchaseCouponLedgerId,jdbcType=BIGINT}"
    })
   int updateCouponLedgerForWriteoff(@Param("purchaseCouponLedgerId")Long purchaseCouponLedgerId,
                                     @Param("confirmedCouponAmount")Long confirmedCouponAmount,
                                     @Param("receivedCouponAmount")Long receivedCouponAmount,
