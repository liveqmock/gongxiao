...
public interface YhglobalReceivedCouponAccountService {
     ...
     */
    WriteOffReturnObject updateYhglobalReceivedCouponAccount(String prefix,GongxiaoRpc.RpcHeader rpcHeader, String currencyCode, long projectId, long couponAmount, Date transactionTime, String orderNo, String sourceFlowNo);
