...
$(function () {
    ...
    function init() {
        ...
        $.getSelectOptions("projectlist", URL + "/project/getProjectList", "projectId", "projectName")
            .then(function () {
                getGatherAmount("/payment/supplier/reserve/sellHighAccount", $pageElement.$rebateInput, "totalAmountDoubleStr");
                // 暂时注释
        ...
        $pageElement.$addupAmountBtn.click(function () {
            ...
            $.get(URL + "/payment/supplier/reserve/sellHighFlowList", totalParams, function (res) {
                if (res.returnCode === 0) {
        ...
        function renderTable() {
            $pageElement.$entryAccountTable.bootstrapTable({
                ...
                url: URL + "/payment/supplier/reserve/sellHighFlowList",
                queryParamsType: '',
                silent: true,
                undefinedText: '',
                striped: true,
