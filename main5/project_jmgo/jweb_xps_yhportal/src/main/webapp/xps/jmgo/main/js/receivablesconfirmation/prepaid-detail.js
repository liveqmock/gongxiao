     ...
     function prepaidDetailInit() {
         ...
         $.get(URL+"/prepaid/info/get",detailParams,function (res) {
             if(res.returnCode === 0){
                 ...
                 var arrInfo = [resData.supplierName,resData.settlementTypeString,resData.payer,resData.settlementNo,resData.receivables,resData.dateBusiness,resData.taxNo,resData.contactInfo,address,resData.bankNameCNY,resData.accountCNY];
                 // 基本信息
