...
$(function () {
    ...
    function confirmInit() {
        ...
        $pageElem.$prepaidBtn.click(function () {
            ...
            var distributorName = selectedData[0]['distributorName'];
            if (selectedData.length !== 0) {
                window.location.href = './cash-confirmlist.html?salesOrderNoList=' + encodeURIComponent(arrReceiveId)+'&distributorName='+distributorName;
            }
        })
    }
        ...
        function BtnStatus() {
            ...
            $.each(tableSelectedData, function (index, item) {
                if(item['confirmStatus'] === 3){
                    statusFlag[item['salesOrderNo']] = false;
                }else if(item['confirmStatus'] === 1 || item['confirmStatus'] === 2){
                    statusFlag[item['salesOrderNo']] = true;
                }
                arr.push(item['distributorName']);
            });
            ...
            if(isAllEqual(arr) && count && !falseCount && tableSelectedData.length !== 0){
