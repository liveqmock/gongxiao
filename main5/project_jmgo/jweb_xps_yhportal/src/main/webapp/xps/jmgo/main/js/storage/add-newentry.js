            ...
            columns: [{
                ...
                formatter: function (value, row) {
                    if (!value) {
                        value = 1;
                        row.purchasePrice = 1;
                        return '<input type="text" class="yhpurinput purchase-price-input" value="' + value + '"' + '/>';
                    } else {
                ...
                events: {
                    'blur .purchase-price-input': function (event, value, row, index) {
                        var $val = $(this).val();
                        $otheraddtable.bootstrapTable('updateCell', {
                            index: index,
                            field: 'purchasePrice',
                ...
                formatter: function (value, row) {
                    if (!value) {
                        value = 1;
                        row.costPrice = 1;
                        return '<input type="text" class="yhpurinput cost-price-input" value="' + value + '"' + '/>';
                    } else {
                        row.costPrice = value;
                        return '<input type="text" class="yhpurinput cost-price-input" value="' + value + '"' + '/>';
                    }
                ...
                events: {
                    'blur .cost-price-input': function (event, value, row, index) {
                        var $val = $(this).val();
                        $otheraddtable.bootstrapTable('updateCell', {
                            index: index,
                            field: 'costPrice',
