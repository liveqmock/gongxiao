    ...
    function managementInit() {
        ...
        $pageElement.$yhCancelBtn.click(function () {
            ...
            $.each(tableData,function (index,confirmDataItem) {
                arrParams[index] = {
                    confirmAmountDouble:confirmDataItem.confirmAmountDouble,
                    receiptAmountDouble:confirmDataItem.receiptAmountDouble,
                    accountTypeStr: confirmDataItem.accountTypeStr,
                    flowCode:confirmDataItem.flowCode
                }
            });
