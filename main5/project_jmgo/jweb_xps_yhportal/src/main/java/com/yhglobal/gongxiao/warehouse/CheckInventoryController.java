...
public class CheckInventoryController {
    ...
    public GongxiaoResult checkinventory(String projectId, String warehouseId, String productCode, String productName, int pageNumber, int pageSize, HttpServletRequest request){
        ...
        try {
            ...
            inventoryCheckModelPageInfo = XpsWarehouseManager.selectCheckInventory(portalConfig.getWarehouseUrl(), WmsSourceChannel.CHANNEL_JMGO.getChannelId(), channelToken, projectId,warehouseId,productCode,productName,pageNumber, pageSize);
