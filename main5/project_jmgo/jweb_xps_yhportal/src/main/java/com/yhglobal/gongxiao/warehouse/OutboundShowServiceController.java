...
import com.yhglobal.gongxiao.warehouseapi.outbound.OutboundOrderBasicInfo;
...
public class OutboundShowServiceController {
    ...
    public GongxiaoResult selectOutboundOrder(String projectId, String gongxiaoOutNo, String salseNo, String
        ...
        try {
            ...
            gongxiaoResult  = XpsWarehouseManager.selectOutboundOrder(portalConfig.getWarehouseUrl(), WmsSourceChannel.CHANNEL_JMGO.getChannelId(),channelToken, projectId, gongxiaoOutNo, salseNo, createTimeBeging, createTimeLast, warehouseId, productCode, finishTimeBegin, finishTimeLast, supplier, customer,pageNumber, pageSize);
    ...
    public GongxiaoResult selectOutboundOrderItem(String projectId, String gongxiaoOutboundOrderNo, String productCode, int inventoryType, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            GongxiaoRpc.RpcHeader rpcHeader = RpcHeaderUtil.createRpcHeader(traceId, portalUserInfo.getUserId(), portalUserInfo.getUserName());
            String channelToken = "474565353";
            gongxiaoResult = XpsWarehouseManager.selectOutboundOrderItem(portalConfig.getWarehouseUrl(), WmsSourceChannel.CHANNEL_JMGO.getChannelId(),channelToken, projectId, gongxiaoOutboundOrderNo);
    ...
    public GongxiaoResult selectOutboundBasicInfo(String projectId, String gongxiaoOutboundOrderNo, String productCode, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            GongxiaoRpc.RpcHeader rpcHeader = RpcHeaderUtil.createRpcHeader(traceId, portalUserInfo.getUserId(), portalUserInfo.getUserName());
            String channelToken = "474565353";
            gongxiaoResult = XpsWarehouseManager.selectByOutboundNum(portalConfig.getWarehouseUrl(), WmsSourceChannel.CHANNEL_JMGO.getChannelId(),channelToken,projectId,gongxiaoOutboundOrderNo);
    ...
    public GongxiaoResult selectSalseToOutboundOrder(String projectId, String inventoryNum, String salseNo, String
        ...
        try {
            ...
            GongxiaoRpc.RpcHeader rpcHeader = RpcHeaderUtil.createRpcHeader(traceId, portalUserInfo.getUserId(), portalUserInfo.getUserName());
            String channelToken = "474565353";
            List<OutboundOrder> resultList = XpsWarehouseManager.selectRecordBySalesNo(portalConfig.getWarehouseUrl(), WmsSourceChannel.CHANNEL_JMGO.getChannelId(),channelToken, projectId, salseNo);
