...
public class AllocationController {
    ...
    public GongxiaoResult selectByAllocateNo(String projectId, String allocateNo, HttpServletRequest request){
        ...
        try {
            ...
            gongxiaoResult = XpsWarehouseManager.selectInfoByAllocateNo(portalConfig.getWarehouseUrl(), WmsSourceChannel.CHANNEL_JMGO.getChannelId(), channelToken,projectId,allocateNo);
    ...
    public GongxiaoResult selectItemByAllocateNo(String projectId, String allocateNo, HttpServletRequest request){
        ...
        try {
            ...
            GongxiaoRpc.RpcHeader rpcHeader = RpcHeaderUtil.createRpcHeader(traceId, portalUserInfo.getUserId(), portalUserInfo.getUserName());
            String channelToken = "34566783653";
            gongxiaoResult = XpsWarehouseManager.selectItemByAllocateNo(portalConfig.getWarehouseUrl(), WmsSourceChannel.CHANNEL_JMGO.getChannelId(), channelToken,projectId,allocateNo);
    ...
    public GongxiaoResult insertAllocateOrder(String companyout, String companyentry, String projectoutId, String projectEntryId, String warehouseOutId,
        ...
        try {
            ...
            XpsWarehouseManager.insertAllocateOrder(portalConfig.getWarehouseUrl(), WmsSourceChannel.CHANNEL_JMGO.getChannelId(), channelToken, companyout, companyentry, projectoutId, projectEntryId, warehouseOutId,
