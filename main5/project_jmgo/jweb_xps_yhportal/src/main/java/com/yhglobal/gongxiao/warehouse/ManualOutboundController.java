...
public class ManualOutboundController {
    ...
    public GongxiaoResult insertManualOutboundOrder(String projectId,
        ...
        try {
            ...
            gongxiaoResult = XpsWarehouseManager.insertManualOutboundOrder(portalConfig.getWarehouseUrl(), WmsSourceChannel.CHANNEL_JMGO.getChannelId(), channelToken, projectId, warehouseId, warehouseName, delieverAddress, supplierName, businessDate, outboundType, remark, itemsInfo);
    ...
    public GongxiaoResult getBatchInfo(HttpServletRequest request, HttpServletResponse response, int pageNumber, int pageSize, String projectId, String productCode, String warehouseId) {
        ...
        try {
            ...
            gongxiaoResult = XpsWarehouseManager.getBatchDetailByWarehouse(portalConfig.getWarehouseUrl(), WmsSourceChannel.CHANNEL_JMGO.getChannelId(), channelToken, projectId, productCode, warehouseId, pageNumber, pageSize);
