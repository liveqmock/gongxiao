...
public class SyncPlanInboundToWmsTask implements Runnable{
    ...
    public void run() {
        try {
            ...
            List<PurchaseOrderItem> purchaseOrderItemList = purchaseOrderItemDao.selectByOrderNo(tablePrefix,purchaseOrderNo);
            ...
            String createdByName = rpcHeader.getUsername();
