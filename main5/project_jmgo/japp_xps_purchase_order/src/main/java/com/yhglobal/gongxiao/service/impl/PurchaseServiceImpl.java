...
//            purchaseOrderDetail.setBrandName(purchaseOrder.getBrandName());
            ...
            purchaseOrderDetail.setSupplierReceipt(purchaseOrder.getSupplierReceipt());
        ...
        try {
            ...
            for (PurchaseOrder purchaseOrder : purchaseOrderList) {
                ...
                PurchaseStructure.PurchaseOrderInfo purchaseOrderInfoBuild = PurchaseStructure.PurchaseOrderInfo.newBuilder()
                        ...
                        .setOrderAmount(DoubleScale.keepTwoBits(purchaseOrder.getPurchaseGuideAmount()))
...
//
    ...
    public void getPurchaseEditDetail(PurchaseStructure.GetPurchaseEditDetailReq request,
        ...
        try {
            ...
            purchaseEditBuilder.setBusinessDate(com.yhglobal.gongxiao.utils.DateUtil.getTime(purchaseOrder.getBusinessDate()));
    ...
    public void createPurchaseOrder(PurchaseStructure.CreatePurchaseOrderReq request,
        ...
        String projectId = purchaseBasicInfo.getProjectId();
        ...
        try {
            ...
            purchaseOrder.setOrderStatus(PurchaseStatus.ORDER_SUBMIT.getStatus());
            ...
            purchaseOrder.setBusinessDate(DateUtil.long2Date(purchaseBasicInfo.getBusinessDate()));
            ...
            GongxiaoRpc.RpcResult rpcResult = GongxiaoRpc.RpcResult.newBuilder().setReturnCode(ErrorCode.SUCCESS.getErrorCode()).setMsg(ErrorCode.SUCCESS.getMessage()).build();
            PurchaseStructure.CreatePurchaseOrderResp createPurchaseOrderResp = PurchaseStructure.CreatePurchaseOrderResp.newBuilder().setRpcResult(rpcResult).build();
            //使用返利与代垫
            SupplierAccountServiceStructure.PayForPurchaseRequest pay = SupplierAccountServiceStructure.PayForPurchaseRequest.newBuilder()
                    ...
                    .setCurrencyCode("CNY")
                    .setProjectId(purchaseOrder.getProjectId())
                    .setCouponToYh(purchaseOrder.getCouponAmountUse())
                    .setCouponToAd(purchaseOrder.getAdCouponAmountUse())
                    .setPrepaidToYh(purchaseOrder.getPrepaidAmountUse())
                    .setPrepaidToAd(purchaseOrder.getAdPrepaidAmountUse())
            ...
            logger.info("采购单号:{} ,扣款完成", oderNumber);
            //5)扣款成功更新订单为付款成功
            purchaseOrderDao.updateAlreadyPay(tablePrefix,oderNumber);
            logger.info("采购单号:{} ,更新扣款状态完成", oderNumber);
            responseObserver.onNext(createPurchaseOrderResp);
            responseObserver.onCompleted();
