...
public final class SupplierAccountServiceGrpc {
  ...
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.yhglobal.gongxiao.payment.microservice.SupplierAccountServiceStructure.SelectSupplierAccountFlowListRequest,
      com.yhglobal.gongxiao.payment.microservice.SupplierAccountServiceStructure.SelectSupplierSellHighFlowListResponse> METHOD_SELECT_SUPPLIER_SELL_HIGH_FLOW_LIST =
      io.grpc.MethodDescriptor.<com.yhglobal.gongxiao.payment.microservice.SupplierAccountServiceStructure.SelectSupplierAccountFlowListRequest, com.yhglobal.gongxiao.payment.microservice.SupplierAccountServiceStructure.SelectSupplierSellHighFlowListResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "SupplierAccountService", "selectSupplierSellHighFlowList"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.yhglobal.gongxiao.payment.microservice.SupplierAccountServiceStructure.SelectSupplierAccountFlowListRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.yhglobal.gongxiao.payment.microservice.SupplierAccountServiceStructure.SelectSupplierSellHighFlowListResponse.getDefaultInstance()))
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.yhglobal.gongxiao.payment.microservice.SupplierAccountServiceStructure.GetSupplierAccountSubtotalRequest,
  ...
  public static abstract class SupplierAccountServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void selectSupplierSellHighFlowList(com.yhglobal.gongxiao.payment.microservice.SupplierAccountServiceStructure.SelectSupplierAccountFlowListRequest request,
        io.grpc.stub.StreamObserver<com.yhglobal.gongxiao.payment.microservice.SupplierAccountServiceStructure.SelectSupplierSellHighFlowListResponse> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_SELECT_SUPPLIER_SELL_HIGH_FLOW_LIST, responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            METHOD_SELECT_SUPPLIER_SELL_HIGH_FLOW_LIST,
            asyncUnaryCall(
              new MethodHandlers<
                com.yhglobal.gongxiao.payment.microservice.SupplierAccountServiceStructure.SelectSupplierAccountFlowListRequest,
                com.yhglobal.gongxiao.payment.microservice.SupplierAccountServiceStructure.SelectSupplierSellHighFlowListResponse>(
                  this, METHODID_SELECT_SUPPLIER_SELL_HIGH_FLOW_LIST)))
          .addMethod(
  ...
  public static final class SupplierAccountServiceStub extends io.grpc.stub.AbstractStub<SupplierAccountServiceStub> {
    ...
    public void selectSupplierSellHighFlowList(com.yhglobal.gongxiao.payment.microservice.SupplierAccountServiceStructure.SelectSupplierAccountFlowListRequest request,
        io.grpc.stub.StreamObserver<com.yhglobal.gongxiao.payment.microservice.SupplierAccountServiceStructure.SelectSupplierSellHighFlowListResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(METHOD_SELECT_SUPPLIER_SELL_HIGH_FLOW_LIST, getCallOptions()), request, responseObserver);
    }
  ...
  public static final class SupplierAccountServiceBlockingStub extends io.grpc.stub.AbstractStub<SupplierAccountServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.yhglobal.gongxiao.payment.microservice.SupplierAccountServiceStructure.SelectSupplierSellHighFlowListResponse selectSupplierSellHighFlowList(com.yhglobal.gongxiao.payment.microservice.SupplierAccountServiceStructure.SelectSupplierAccountFlowListRequest request) {
      return blockingUnaryCall(
          getChannel(), METHOD_SELECT_SUPPLIER_SELL_HIGH_FLOW_LIST, getCallOptions(), request);
    }
  ...
  public static final class SupplierAccountServiceFutureStub extends io.grpc.stub.AbstractStub<SupplierAccountServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yhglobal.gongxiao.payment.microservice.SupplierAccountServiceStructure.SelectSupplierSellHighFlowListResponse> selectSupplierSellHighFlowList(
        com.yhglobal.gongxiao.payment.microservice.SupplierAccountServiceStructure.SelectSupplierAccountFlowListRequest request) {
      return futureUnaryCall(
          getChannel().newCall(METHOD_SELECT_SUPPLIER_SELL_HIGH_FLOW_LIST, getCallOptions()), request);
    }
  ...
  private static final int METHODID_SELECT_SUPPLIER_SELL_HIGH_FLOW_LIST = 11;
  private static final int METHODID_GET_SELL_HIGH_SUBTOTAL = 12;
  private static final int METHODID_SELECT_PREPAID_BY_SUPPLIER_ID = 13;
  private static final int METHODID_SELECT_INCOME_AND_EXPENDITURE = 14;
      ...
      switch (methodId) {
        ...
        case METHODID_UPDATE_SUPPLIER_SELL_HIGH_ACCOUNT_ON_JMGO:
          serviceImpl.updateSupplierSellHighAccountOnJmgo((com.yhglobal.gongxiao.payment.microservice.SupplierAccountServiceStructure.UpdateSupplierSellHighAccountOnJmgoRequest) request,
              (io.grpc.stub.StreamObserver<com.yhglobal.gongxiao.microservice.GongxiaoRpc.RpcResult>) responseObserver);
          break;
        case METHODID_SELECT_SUPPLIER_SELL_HIGH_FLOW_LIST:
          serviceImpl.selectSupplierSellHighFlowList((com.yhglobal.gongxiao.payment.microservice.SupplierAccountServiceStructure.SelectSupplierAccountFlowListRequest) request,
              (io.grpc.stub.StreamObserver<com.yhglobal.gongxiao.payment.microservice.SupplierAccountServiceStructure.SelectSupplierSellHighFlowListResponse>) responseObserver);
          break;
      ...
      synchronized (SupplierAccountServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(METHOD_SELECT_SUPPLIER_SELL_HIGH_FLOW_LIST)
