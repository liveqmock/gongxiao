  ...
  <div class="project-management" id="project-management">
      ...
      <el-form :inline="true" :model="dataForm" label-width="100px">
        <el-row>
          <el-form-item label="型号">
            <el-input v-model="dataForm.goodCode" placeholder="型号" clearable></el-input>
          </el-form-item>
          <el-form-item label="货品名称">
            <el-input v-model="dataForm.goodCode" placeholder="货品名称 " clearable></el-input>
          </el-form-item>
    ...
    <div class="jd-purchase-order-table">
      <el-table :data="tableData">
        ...
        <el-table-column align="center" header-align="center" prop="supplierOrderNo" label="货品编码"></el-table-column>
        <el-table-column align="center" header-align="center" prop="supplierOrderNo" label="货品名称"></el-table-column>
        <el-table-column align="center" header-align="center" prop="supplierOrderNo" label="采购指导价"></el-table-column>
        <el-table-column align="center" header-align="center" prop="supplierOrderNo" label="销售指导价"></el-table-column>
        <el-table-column align="center" header-align="center" prop="supplierOrderNo" label="税率"></el-table-column>
        <el-table-column align="center" header-align="center" prop="supplierOrderNo" label="实销返点"></el-table-column>
        <el-table-column align="center" header-align="center" prop="supplierOrderNo" label="应销返点"></el-table-column>
        <el-table-column align="center" header-align="center" prop="supplierOrderNo" label="厂送返点"></el-table-column>
        <el-table-column align="center" header-align="center" prop="supplierOrderNo" label="状态"></el-table-column>
        <el-table-column align="center" header-align="center" prop="supplierOrderNo" label="操作人"></el-table-column>
        <el-table-column align="center" header-align="center" prop="supplierOrderNo" label="更新时间"></el-table-column>
