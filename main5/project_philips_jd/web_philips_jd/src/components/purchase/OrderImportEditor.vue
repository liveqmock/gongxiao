<template>
  <div class="order-import-editor" id="order-import-editor">
    <div class="order-import-editor-form">
      <el-form :inline="true" :model="dataForm" class="" labelWidth="130px">
        ...
        <div label-position="right">
          <h4 style="border-left: 2px solid #1a6acb; padding-left: 3px;">货品信息</h4>
          <div class="order-import-editor-table" id="order-import-editor-table">
