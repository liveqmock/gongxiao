<template>
  <div class="purchase-plan-details-approval" id="purchase-plan-details-approval">
    <div class="purchase-plan-details-approval-form">
      <el-form :inline="true" :model="dataForm" class="" labelWidth="130px">
        ...
        <div label-position="right">
          ...
          <div class="essentialInfo" id="tableDate" >
            ...
            <el-row>
              <el-form-item label="采购前返金额">
                <el-input v-model="dataForm.test" placeholder="采购前返金额" disabled clearable></el-input>
              </el-form-item>
            ...
            <el-row>
              <el-form-item label="计划实付金额">
                <el-input v-model="dataForm.test" placeholder="计划实付金额" disabled clearable></el-input>
              </el-form-item>
              <el-form-item label="预计现金返点金额 ">
                <el-input v-model="dataForm.test" placeholder="预计现金返点金额" disabled clearable></el-input>
              </el-form-item>
            </el-row>
            <el-row>
              ...
              <el-form-item label="预计可使用现金">
                <el-input v-model="dataForm.test" placeholder="预计可使用现金" disabled clearable></el-input>
              </el-form-item>
            </el-row>
            <el-row>
            ...
            <el-row>
              <el-form-item label="备注" >
                <el-input type="textarea" v-model="dataForm.test" style="width: 570px;" disabled></el-input>
              </el-form-item>
            </el-row>
          </div>
        </div>
        ...
        <div class="purchase-plan-details-approval-table" id="purchase-plan-details-approval-table">
        ...
        <div clasee="exportBtn" id="exportBtn">
          <el-button type="primary" @click="preservation()" style=" margin-left: 40%">审批</el-button>
          <el-button type="primary" @click="preservation()" style=" margin-left: 3%">驳回</el-button>
