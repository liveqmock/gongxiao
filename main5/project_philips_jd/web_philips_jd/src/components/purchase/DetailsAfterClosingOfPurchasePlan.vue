<template>
  <div class="detailsAfter-closing-purchase-plan" id="detailsAfter-closing-purchase-plan">
    <div class="detailsAfter-closing-purchase-plan-form">
      <el-form :inline="true" :model="dataForm" class="" labelWidth="130px">
        ...
        <div class="detailsAfter-closing-purchase-plan-table" id="detailsAfter-closing-purchase-plan-table">
