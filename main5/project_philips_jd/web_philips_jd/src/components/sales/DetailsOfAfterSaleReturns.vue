<template>
  ...
  <div class="product-added" id="product-added">
    <el-form :model="productManagement" :rules="rules" label-width="100px" class="demo-ruleForm" clearable>
      ...
      <div label-position="right">
        ...
        <div class="project-management-table" id="project-management-table">
          <el-table height="250" style="width: 100%" :data="tableData">
            ...
            <el-table-column align="center" header-align="center" prop="model" label="实收良品"></el-table-column>
            <el-table-column align="center" header-align="center" prop="model" label="实收残品"></el-table-column>
        ...
        <div class="essentialInfo" id="essentialInfo3" style="padding-left: 7%;">
          ...
          <el-row>
            <el-form-item label="退货发出仓库">
              <el-select v-model="productManagement.salelong" placeholder="请选择" disabled>
          ...
          <el-row>
            <el-form-item label="联系方式">
              <el-input v-model="productManagement.salelong" placeholder="联系方式" clearable disabled></el-input>
            </el-form-item>
      ...
      <div label-position="right">
        <h4 style="border-left: 2px solid #1a6acb; padding-left: 3px;">操作记录</h4>
        <div class="project-management-table" id="project-management-table2">
          <el-table height="250" style="width: 100%" :data="tableData">
            <el-table-column align="center" header-align="center" prop="goodsName" label="状态"></el-table-column>
            <el-table-column align="center" header-align="center" prop="model" label="操作功能"></el-table-column>
            <el-table-column align="center" header-align="center" prop="WMSCoding" label="操作时间"></el-table-column>
            <el-table-column align="center" header-align="center" prop="project" label="操作人"></el-table-column>
          </el-table>
        </div>
      </div>
