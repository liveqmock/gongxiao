        ...
        <div class="taxRate" id="taxRate" style="padding-left: 7%;">
          <el-row>
            <el-form-item label="收货人" prop="purchasingGuidancePrice">
              <el-input v-model="productManagement.purchasingGuidancePrice" disabled clearable style="width: 150px;"></el-input>
            </el-form-item>
            <el-form-item label="手机" style="margin-left: -9px;" prop="taxRate">
              <el-input v-model="productManagement.taxRate" disabled clearable style="width: 150px;"></el-input>
            </el-form-item>
            <el-form-item label="发货仓" style="padding-left: 5px;" prop="taxonomyTaxRate">
              <el-input v-model="productManagement.taxonomyTaxRate" disabled clearable style="width: 300px;"></el-input>
            </el-form-item>
          </el-row>
          <el-row>
            <el-form-item label="地址" prop="salesGuidancePrice">
              <el-input v-model="productManagement.salesGuidancePrice" disabled clearable style="width: 390px;"></el-input>
            </el-form-item>
            <el-form-item label="收货公司" style="margin-left: 6px;" prop="realSalesRebate">
              <el-input v-model="productManagement.realSalesRebate" disabled clearable style="width: 300px;"></el-input>
            </el-form-item>
          </el-row>
          <el-row>
            <el-form-item label="详细地址" prop="factorySendRebatePoint">
              <el-input v-model="productManagement.factorySendRebatePoint" disabled clearable style="width: 796px;"></el-input>
            </el-form-item>
          </el-row>
        </div>
      </div>
