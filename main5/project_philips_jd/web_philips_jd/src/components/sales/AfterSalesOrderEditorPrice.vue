      ...
      <div label-position="right">
        ...
        <div class="project-management-table" id="project-management-table">
          <el-table height="250" style="width: 100%" :data="tableData">
            ...
            <el-table-column align="center" header-align="center" prop="goodsName" label="退货总金额"></el-table-column>
            <el-table-column align="center" header-align="center" prop="model" label="实收良品"></el-table-column>
            <el-table-column align="center" header-align="center" prop="WMSCoding" label="实收残品"></el-table-column>
            <el-table-column align="center" header-align="center" prop="project" label="报废数量"></el-table-column>
            <el-table-column align="center" header-align="center" prop="state" label="描述"></el-table-column>
          </el-table>
        </div>
      </div>
        ...
        <div class="essentialInfo" id="essentialInfo3" style="padding-left: 7%;">
          ...
          <el-row>
            <el-form-item label="联系方式">
              <el-input v-model="productManagement.salelong" placeholder="联系方式" clearable></el-input>
            </el-form-item>
