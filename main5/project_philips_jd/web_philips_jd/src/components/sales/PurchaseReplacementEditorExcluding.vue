  ...
  <div class="purchase-management" id="purchase-management">
    ...
    <div class="purchase-management-table">
      <el-table :data="tableData">
        ...
        <el-table-column align="center" stripe header-align="center" :row-class-name="tableRowClassName" prop="Customer purchase number" label="客户采购单号"></el-table-column>
        ...
        <el-table-column align="center" header-align="center" prop="quantityRemainingShipments" label="剩余发货数量"></el-table-column>
