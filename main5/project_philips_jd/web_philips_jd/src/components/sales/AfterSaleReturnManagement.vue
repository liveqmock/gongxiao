  ...
  <div class="purchase-management" id="purchase-management">
      ...
      <el-form :inline="true" :model="salesInfo" class="" label-width="100px">
        <el-row>
          ...
          <el-form-item label="型号">
            <el-input v-model="salesInfo.region" placeholder="型号" clearable></el-input>
          </el-form-item>
        </el-row>
        ...
        <el-row>
          ...
          <el-form-item label="退货单号">
            <el-input v-model="salesInfo.region" placeholder="退货单号" clearable></el-input>
          </el-form-item>
        </el-row>

        <el-row>
          <el-form-item label="退货状态" prop="region">
            <el-select v-model="salesInfo.region" prop="whichLocated2" style="width: 222px;">
              <el-option label="区域一" value="shanghai"></el-option>
              <el-option label="区域二" value="beijing"></el-option>
            </el-select>
    ...
    <div clasee="exportBtn block" id="exportBtn">
      <div style="font-size: 14px; color: #909399; padding-left: 40px; background-color: whitesmoke">
        <el-row>
          ...
          <span style="color: coral;">(100)</span>
          <el-button type="text" plain @click="onAudited">报废</el-button>
          <span style="color: coral;">(100)</span>
      ...
      <div clasee="exportBtn block" id="exportBtns" style="background-color: #F5F5F5;">
        <el-button type="button" onclick="exportWarehouseFile()" style=" margin-left: 3%">项目确认</el-button>
        <el-button type="button" onclick="exportWarehouseFile()" style=" margin-left: 3%">换货</el-button>
    ...
    <div class="purchase-management-table">
      <el-table :data="tableData">
        ...
        <el-table-column align="center" stripe header-align="center" :row-class-name="tableRowClassName" prop="Customer purchase number" label="京东退货单号"></el-table-column>
        <el-table-column align="center" header-align="center" prop="oddNumbers" label="YH退货单号"></el-table-column>
        <el-table-column align="center" header-align="center" prop="orderAttribute" label="项目名称"></el-table-column>
        <el-table-column align="center" header-align="center" prop="orderStatus" label="批次匹配标识"></el-table-column>
        <el-table-column align="center" header-align="center" prop="amountOfMoney" label="退货金额"></el-table-column>
        <el-table-column align="center" header-align="center" prop="customerInformation" label="退货状态"></el-table-column>
        <el-table-column align="center" header-align="center" prop="orderTime" label="发货仓库"></el-table-column>
        <el-table-column align="center" header-align="center" prop="collectionTime" label="退回仓库"></el-table-column>
        <el-table-column align="center" header-align="center" prop="quantityRemainingShipments" label="退单创建时间"></el-table-column>
        ...
        <el-table-column align="center" header-align="center" prop="accountNumber" label="结算方"></el-table-column>
