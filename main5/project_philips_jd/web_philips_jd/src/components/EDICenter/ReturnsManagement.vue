  ...
  <div class="project-management" id="project-management">
    ...
    <div class="jd-purchase-order-table">
      <el-table :data="tableData">
        ...
        <el-table-column align="center" header-align="center" prop="supplierOrderNo" label="单据号"></el-table-column>
        <el-table-column align="center" header-align="center" prop="supplierOrderNo" label="单据属性"></el-table-column>
