  ...
  <div class="project-management" id="project-management">
      ...
      <el-form :inline="true" :model="dataForm" label-width="100px">
        ...
        <el-row>
          ...
          <el-form-item label="单据类型">
            <el-select v-model="dataForm.warehouseId" placeholder="单据类型"></el-select>
          </el-form-item>
        </el-row>
        <el-row>
          <el-form-item label="开始日期">
            <el-date-picker v-model="dataForm.startDate" type="date"
    ...
    <div class="jd-purchase-order-table">
      <el-table :data="tableData">
        ...
        <el-table-column align="center" header-align="center" prop="supplierOrderNo" label="单号"></el-table-column>
        <el-table-column align="center" header-align="center" prop="supplierOrderNo" label="单据类型"></el-table-column>
