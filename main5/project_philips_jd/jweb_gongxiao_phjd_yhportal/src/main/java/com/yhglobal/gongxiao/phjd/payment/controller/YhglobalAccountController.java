...
public class YhglobalAccountController {
    ...
    public GongxiaoResult getYhglobalReceivedAccount(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            SupplierAccountServiceStructure.GetSupplierCouponBufferToDistributorRequest rpcRequest2 = SupplierAccountServiceStructure.GetSupplierCouponBufferToDistributorRequest.newBuilder()
            ...
            PaymentCommonGrpc.AccountAmountResponse rpcResponse2 = rpcStub.getSupplierCouponBufferToDistributor(rpcRequest2);
            AccountAmount yhglobalBufferAccountAmount = AccountProtoUtil.getJavaAccountAmount(rpcResponse2);

            yhglobalReceivedAccountAmount.setCouponBufferAmountDouble(yhglobalBufferAccountAmount.getCouponAmountDouble());
            yhglobalReceivedAccountAmount.setPrepaidBufferAmountDouble(yhglobalBufferAccountAmount.getPrepaidAmountDouble());
