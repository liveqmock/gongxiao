...
public final class PurchaseFileServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.yhglobal.gongxiao.phjd.purchase.microservice.PurchaseFileStructure.PurchaseFileReq,
      com.yhglobal.gongxiao.phjd.purchase.microservice.PurchaseFileStructure.PurchaseFileResp> METHOD_PARSE_PURCHASE_ORDER_LIST =
      io.grpc.MethodDescriptor.<com.yhglobal.gongxiao.phjd.purchase.microservice.PurchaseFileStructure.PurchaseFileReq, com.yhglobal.gongxiao.phjd.purchase.microservice.PurchaseFileStructure.PurchaseFileResp>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "PurchaseFileService", "parsePurchaseOrderList"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.yhglobal.gongxiao.phjd.purchase.microservice.PurchaseFileStructure.PurchaseFileReq.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.yhglobal.gongxiao.phjd.purchase.microservice.PurchaseFileStructure.PurchaseFileResp.getDefaultInstance()))
          .build();
  ...
  public static abstract class PurchaseFileServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void parsePurchaseOrderList(com.yhglobal.gongxiao.phjd.purchase.microservice.PurchaseFileStructure.PurchaseFileReq request,
        io.grpc.stub.StreamObserver<com.yhglobal.gongxiao.phjd.purchase.microservice.PurchaseFileStructure.PurchaseFileResp> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.yhglobal.gongxiao.phjd.purchase.microservice.PurchaseFileStructure.PurchaseFileReq,
                com.yhglobal.gongxiao.phjd.purchase.microservice.PurchaseFileStructure.PurchaseFileResp>(
  ...
  public static final class PurchaseFileServiceBlockingStub extends io.grpc.stub.AbstractStub<PurchaseFileServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.yhglobal.gongxiao.phjd.purchase.microservice.PurchaseFileStructure.PurchaseFileResp parsePurchaseOrderList(com.yhglobal.gongxiao.phjd.purchase.microservice.PurchaseFileStructure.PurchaseFileReq request) {
  ...
  public static final class PurchaseFileServiceFutureStub extends io.grpc.stub.AbstractStub<PurchaseFileServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yhglobal.gongxiao.phjd.purchase.microservice.PurchaseFileStructure.PurchaseFileResp> parsePurchaseOrderList(
        com.yhglobal.gongxiao.phjd.purchase.microservice.PurchaseFileStructure.PurchaseFileReq request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PARSE_PURCHASE_ORDER_LIST:
          serviceImpl.parsePurchaseOrderList((com.yhglobal.gongxiao.phjd.purchase.microservice.PurchaseFileStructure.PurchaseFileReq) request,
              (io.grpc.stub.StreamObserver<com.yhglobal.gongxiao.phjd.purchase.microservice.PurchaseFileStructure.PurchaseFileResp>) responseObserver);
          break;
        default:
  ...
  private static final class PurchaseFileServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.yhglobal.gongxiao.phjd.purchase.microservice.PurchaseFileStructure.getDescriptor();
    }
  }
