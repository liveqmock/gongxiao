...
public class SupplierSalesDifferenceReservedAccountTransferFlow implements Serializable{
    /**
     * 流水id
     */
    private Long flowId;
    ...
    /**
     * 该流水的流水号(用于返回给对应的供应商过账流水表和对应的buffer表)
     * @return flowNo 该流水的流水号(用于返回给对应的供应商过账流水表和对应的buffer表)
     */
    ...
    /**
     * 该流水的流水号(用于返回给对应的供应商过账流水表和对应的buffer表)
     * @param flowNo 该流水的流水号(用于返回给对应的供应商过账流水表和对应的buffer表)
     */
