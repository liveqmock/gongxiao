    ...
    public RpcResult<PurchaseFlowCollections> payForPurchase(String prefix,
        ...
        try {
            ...
            if (couponToAd > 0) {
                try {
                    //上账账户扣款 插入记录
                    String postFlowNo = supplierCouponAccountService.updateSupplierCouponAccount(prefix, rpcHeader, currencyCode, projectId, -couponToYh, transactionTime, null, purchaseOrderNo, "Yhglobal");
                    //转账到AD过账账户
                    String transferFlowNo = supplierCouponBufferToDistributorService.updateCouponBufferToDistributorAccount(prefix, rpcHeader, currencyCode, projectId, null, null, couponToYh, purchaseOrderNo, transactionTime, null, postFlowNo);
            ...
            if (prepaidToAd > 0) {
                try {
                    //上账账户扣款
                    String postFlowNo = supplierPrepaidAccountService.updateSupplierPrepaidAccount(prefix, rpcHeader, currencyCode, projectId, -couponToYh, transactionTime, null, purchaseOrderNo, "Distributor");
                    //转账到越海缓冲账户
                    String flowNo = supplierPrepaidBufferToDistributorService.updatePrepaidBufferToDistributorAccount(prefix, rpcHeader, currencyCode, projectId, null, null, couponToYh, purchaseOrderNo, transactionTime, null, postFlowNo);
