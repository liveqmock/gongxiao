...
public interface SupplierSalesDifferenceReservedAccountTransferFlowMapper extends BaseMapper{
    /**
     * This method was generated by MyBatis Generator.
     * This method corresponds to the database table supplier_sales_difference_reserved_account_transfer_flow
     *
     * @mbggenerated
     */
    @Delete({
        "delete from supplier_sales_difference_reserved_account_transfer_flow",
        "where flowId = #{flowId,jdbcType=BIGINT}"
    })
    int deleteByPrimaryKey(Long flowId);

    @SelectProvider(type = SupplierSalesDifferenceReservedAccountTransferFlowSqlProvider.class, method = "selectByConditions")
    List<SupplierSalesDifferenceReservedAccountTransferFlow> selectByConditions(@Param("moneyFlow") Integer moneyFlow,
                                                                               @Param("dateS") Date dateS,
                                                                               @Param("dateE") Date dateE, @Param("tablePrefix") String tablePrefix);
    @SelectProvider(type = SupplierSalesDifferenceReservedAccountTransferFlowSqlProvider.class, method = "selectTotal")
     ...
     */
    @Insert({
        "insert into ${tablePrefix}_supplier_sales_difference_reserved_account_transfer_flow (flowId, flowNo, ",
    ...
    int insert(SupplierSalesDifferenceReservedAccountTransferFlow record);
    ...
    @Select({
        ...
        "from supplier_sales_difference_reserved_account_transfer_flow",
        "where flowId = #{flowId,jdbcType=BIGINT}"
    })
    @Results({
    ...
    SupplierSalesDifferenceReservedAccountTransferFlow selectByPrimaryKey(Long flowId);
     ...
     */
    @Update({
        "update supplier_sales_difference_reserved_account_transfer_flow",
    ...
    int updateByPrimaryKeyWithBLOBs(SupplierSalesDifferenceReservedAccountTransferFlow record);
    ...
    int updateByPrimaryKey(SupplierSalesDifferenceReservedAccountTransferFlow record);
}