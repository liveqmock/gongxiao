...
public interface SupplierPurchaseReservedFrozenAccountTransferRecordMapper extends BaseMapper{
    @Delete({
        "delete from ${tablePrefix}_supplier_purchase_reserved_frozen_account_transfer_record",
        "where recordId = #{recordId,jdbcType=BIGINT}"
    })
    int deleteByPrimaryKey(Long recordId, String tablePrefix);

    @Insert({
        "insert into ${tablePrefix}_supplier_purchase_reserved_frozen_account_transfer_record (recordId, currencyCode, ",
    ...
    int insert(SupplierPurchaseReservedFrozenAccountTransferRecord record);
    ...
    @Select({
        ...
        "from ${tablePrefix}_supplier_purchase_reserved_frozen_account_transfer_record",
        "where recordId = #{recordId,jdbcType=BIGINT}"
    })
    @Results({
    ...
    SupplierPurchaseReservedFrozenAccountTransferRecord selectByPrimaryKey(Long recordId, String tablePrefix);

//    @SelectProvider(type = SupplierPurchaseReservedFrozenAccountTransferRecordSqlProvider.class, method = "selectByConditions")
//    List<SupplierPurchaseReservedFrozenAccountTransferRecord> selectByConditions(@Param("moneyFlow") Integer moneyFlow,
//                                                                                 @Param("dateS") Date dateS,
//                                                                                 @Param("dateE") Date dateE, @Param("tablePrefix") String tablePrefix);
//    @SelectProvider(type = SupplierPurchaseReservedFrozenAccountTransferRecordSqlProvider.class, method = "selectTotal")
...
//                                   @Param("dateE") Date dateE, @Param("tablePrefix") String tablePrefix);
    ...
    @Update({
        "update ${tablePrefix}_supplier_purchase_reserved_frozen_account_transfer_record",
    ...
    int updateByPrimaryKey(SupplierPurchaseReservedFrozenAccountTransferRecord record);
}