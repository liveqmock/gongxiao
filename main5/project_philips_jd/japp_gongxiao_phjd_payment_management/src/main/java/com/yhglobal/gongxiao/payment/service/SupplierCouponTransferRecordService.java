 ...
 * @author: 葛灿
 */
public interface SupplierCouponTransferRecordService {
    ...
    String insertRecord(String prefix, GongxiaoRpc.RpcHeader rpcHeader,
                        ...
                        String currencyCode, BigDecimal amountBeforeTransfer,
                        BigDecimal transferAmount, Date transferTime,
                        String purchaseOrderNo, String transferAccountType,
                        String remark);
