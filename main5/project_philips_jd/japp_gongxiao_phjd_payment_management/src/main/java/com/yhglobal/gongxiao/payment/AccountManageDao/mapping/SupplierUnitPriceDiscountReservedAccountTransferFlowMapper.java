...
public interface SupplierUnitPriceDiscountReservedAccountTransferFlowMapper extends BaseMapper{
    /**
     * This method was generated by MyBatis Generator.
     * This method corresponds to the database table supplier_unit_price_discount_reserved_account_transfer_flow
     *
     * @mbggenerated
     */
    @Delete({
        "delete from supplier_unit_price_discount_reserved_account_transfer_flow",
        "where flowId = #{flowId,jdbcType=BIGINT}"
    })
    int deleteByPrimaryKey(Long flowId);

    @SelectProvider(type = SupplierUnitPriceDiscountReservedAccountTransferFlowSqlProvider.class, method = "selectByConditions")
    List<SupplierUnitPriceDiscountReservedAccountTransferFlow> selectByConditions(@Param("moneyFlow") Integer moneyFlow,
                                                                                @Param("dateS") Date dateS,
                                                                                @Param("dateE") Date dateE, @Param("tablePrefix") String tablePrefix);
    @SelectProvider(type = SupplierUnitPriceDiscountReservedAccountTransferFlowSqlProvider.class, method = "selectTotal")
     ...
     */
    @Insert({
        "insert into ${tablePrefix}_supplier_unit_price_discount_reserved_account_transfer_flow (flowId, flowNo, ",
    ...
    int insert(SupplierUnitPriceDiscountReservedAccountTransferFlow record);
    ...
    @Select({
        ...
        "createdByName, purchaseOrderNo, flowType, createTime, sourceFlowNo, remark",
        "from supplier_unit_price_discount_reserved_account_transfer_flow",
        "where flowId = #{flowId,jdbcType=BIGINT}"
    })
    @Results({
    ...
    SupplierUnitPriceDiscountReservedAccountTransferFlow selectByPrimaryKey(Long flowId);
     ...
     */
    @Update({
        "update supplier_unit_price_discount_reserved_account_transfer_flow",
    ...
    int updateByPrimaryKeyWithBLOBs(SupplierUnitPriceDiscountReservedAccountTransferFlow record);
    ...
    int updateByPrimaryKey(SupplierUnitPriceDiscountReservedAccountTransferFlow record);
}