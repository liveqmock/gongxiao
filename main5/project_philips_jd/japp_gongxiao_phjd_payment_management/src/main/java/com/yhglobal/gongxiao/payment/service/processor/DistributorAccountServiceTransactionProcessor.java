...
public interface DistributorAccountServiceTransactionProcessor {
     ...
     * @return
     */
    RpcResult<CashCouponPrepaidFlows> payForSalesOrder(GongxiaoRpc.RpcHeader rpcHeader,
     ...
     * @return
     */
    RpcResult<CashCouponPrepaidFlows> returnForSalesReturnOrder(GongxiaoRpc.RpcHeader rpcHeader,
                                                                String currencyCode, long distributorId,
                                                                long projectId, long couponAmount,
                                                                long prepaidAmount, long cashAmount,
     ...
     * @return
     */
    RpcResult<String> depositCouponReceived(GongxiaoRpc.RpcHeader rpcHeader,
                                            String currencyCode,
                                            long distributorId,
     ...
     * @return
     */
    RpcResult<String> depositPrepaidReceived(GongxiaoRpc.RpcHeader rpcHeader,
                                             String currencyCode, long distributorId,
                                             String distributorName,
     ...
     * @return
     */
    RpcResult depositCouponReceivedAccounts(GongxiaoRpc.RpcHeader rpcHeader, List<DistributorCouponAccount> distributorCouponAccounts);
     ...
     * @return
     */
    RpcResult depositPrepaidReceivedAccounts(GongxiaoRpc.RpcHeader rpcHeader, List<DistributorPrepaidAccount> distributorPrepaidAccounts);
