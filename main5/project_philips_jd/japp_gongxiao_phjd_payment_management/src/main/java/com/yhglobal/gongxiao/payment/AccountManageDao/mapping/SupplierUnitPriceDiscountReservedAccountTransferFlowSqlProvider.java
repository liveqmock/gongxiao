...
public class SupplierUnitPriceDiscountReservedAccountTransferFlowSqlProvider {
    ...
    public String selectByConditions(@Param("moneyFlow") Integer moneyFlow,
        ...
        return new SQL() {{
            ...
            FROM(tablePrefix+"_supplier_unit_price_discount_reserved_account_transfer_flow");
