...
public interface SupplierPurchaseReservedAccountTransferFlowMapper extends BaseMapper{
    /**
     * This method was generated by MyBatis Generator.
     * This method corresponds to the database table supplier_purchase_reserved_account_transfer_record
     *
     * @mbggenerated
     */
    @Delete({
        "delete from supplier_purchase_reserved_account_transfer_record",
        "where recordId = #{recordId,jdbcType=BIGINT}"
    })
    int deleteByPrimaryKey(Long recordId);

    @SelectProvider(type = SupplierPurchaseReservedAccountTransferFlowSqlProvider.class, method = "selectByConditions")
    List<SupplierPurchaseReservedAccountTransferFlow> selectByConditions(@Param("moneyFlow") Integer moneyFlow,
                                                                         @Param("dateS") Date dateS,
                                                                         @Param("dateE") Date dateE, @Param("tablePrefix") String tablePrefix);
    @SelectProvider(type = SupplierPurchaseReservedAccountTransferFlowSqlProvider.class, method = "selectTotal")
     ...
     */
    @Insert({
        "insert into ${tablePrefix}_supplier_purchase_reserved_account_transfer_flow (flowId, flowNo, ",
    ...
    int insert(SupplierPurchaseReservedAccountTransferFlow record);
    ...
    @Select({
        ...
        "createdByName, purchaseOrderNo, flowNo, recordType, createTime",
        "from supplier_purchase_reserved_account_transfer_record",
        "where recordId = #{recordId,jdbcType=BIGINT}"
    })
    @Results({
    ...
    SupplierPurchaseReservedAccountTransferFlow selectByPrimaryKey(Long recordId);
     ...
     */
    @Update({
        "update supplier_purchase_reserved_account_transfer_record",
    ...
    int updateByPrimaryKey(SupplierPurchaseReservedAccountTransferFlow record);
}