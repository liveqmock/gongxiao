...
public interface SupplierPurchaseReservedFrozenAccountMapper extends BaseMapper{
    @Delete({
        "delete from ${tablePrefix}_supplier_purchase_reserved_frozen_account",
        "where supplierId = #{supplierId,jdbcType=BIGINT}"
    })
    int deleteByPrimaryKey(Long supplierId, String tablePrefix);

    @Insert({
        "insert into ${tablePrefix}_supplier_purchase_reserved_frozen_account (supplierId, supplierName, ",
    ...
    int insert(SupplierPurchaseReservedFrozenAccount record);

    @Update({
            "update ${tablePrefix}_supplier_purchase_reserved_frozen_account",
    ...
    @Select({
        ...
        "from ${tablePrefix}_supplier_purchase_reserved_frozen_account",
        "where supplierId = #{supplierId,jdbcType=BIGINT}"
    })
    @Results({
    ...
    SupplierPurchaseReservedFrozenAccount selectByPrimaryKey(Long supplierId);
    ...
    SupplierPurchaseReservedFrozenAccount selectByProjectId(@Param("projectId") Long projectId, @Param("tablePrefix") String tablePrefix);
    ...
    int updateByPrimaryKeyWithBLOBs(SupplierPurchaseReservedFrozenAccount record);
    ...
    int updateByPrimaryKey(SupplierPurchaseReservedFrozenAccount record);
}