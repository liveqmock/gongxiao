...
public class DistributorCashFlowDao {
    ...
    public List<DistributorCashFlow> selectAllBydistributorId(String currencyCode, long distributorId, long projectId, int moneyFlow,
                                                              String beginDate,
                                                              String endDate) {
    ...
    public  List<FlowSubtotal> selectIncomeAndExpenditure(String currencyCode, long distributorId, long projectId, int moneyFlow, String beginDate, String endDate) {
