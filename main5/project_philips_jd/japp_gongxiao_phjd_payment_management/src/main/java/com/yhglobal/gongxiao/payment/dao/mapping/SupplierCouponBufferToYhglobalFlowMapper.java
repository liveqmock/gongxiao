...
public interface SupplierCouponBufferToYhglobalFlowMapper extends BaseMapper {

    @Insert({
            "insert into ${prefix}_supplier_coupon_buffer_to_yhglobal_flow (flowId, flowNo, ",
    ...
    int insert(@Param("prefix") String prefix,
               @Param("record") SupplierCouponBufferToYhglobalFlow record);


    @Update({
            "update ${prefix}_supplier_coupon_buffer_to_yhglobal_flow",
