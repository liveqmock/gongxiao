...
import com.yhglobal.gongxiao.eas.model.PurchaseEasInboundModel;
import com.yhglobal.gongxiao.microservice.GongxiaoRpc;
import com.yhglobal.gongxiao.warehouse.model.purchase.InboundNotificationBackItem;
import com.yhglobal.gongxiao.warehouse.model.purchase.PlanInboundItem;
...
public interface InboundNotificationService {
     ...
     */
    PurchaseEasInboundModel transferReceivedNotification(GongxiaoRpc.RpcHeader rpcHeader,
                                                         String projectId,
                                                         String traceNo,
    ...
    GongxiaoRpc.RpcResult notifyPurchaseInbound(GongxiaoRpc.RpcHeader rpcHeader,
                                                String projectId,
                                                String traceNo,
                                                String gongxiaoInboundOrderNo,
                                                List<InboundNotificationBackItem> inboundNotificationBackItemList,
     ...
     */
    int transferMisReceivedNotification(GongxiaoRpc.RpcHeader rpcHeader,
                                        String projectId,
                                        String traceNo,
                                        String gongxiaoInboundOrderNo,
     ...
     * @return
     */
    GongxiaoRpc.RpcResult transferClosedNotification(GongxiaoRpc.RpcHeader rpcHeader,
                                                     String projectId,
                                                     String traceNo,
                                                     String gongxiaoInboundOrderNo,
                                                     String batchNo,
