...
public interface OutboundNotificationService {
     ...
     */
    int transferDepartureNotification(GongxiaoRpc.RpcHeader rpcHeader, String projectId, String traceNo, String gongxiaoOutboundOrderNo, List<OutboundNotificationBackItem> planOutboundItemList);
...
//    int transferSignedNotification(RpcHeader rpcHeader, String projectId, String traceNo, String gongxiaoOutboundOrderNo, List<PlanOutboundItem> planOutboundItemList);
     ...
     * @return
     */
    int transferClosedNotification(GongxiaoRpc.RpcHeader rpcHeader, String projectId, String traceNo, String gongxiaoOutboundOrderNo);
