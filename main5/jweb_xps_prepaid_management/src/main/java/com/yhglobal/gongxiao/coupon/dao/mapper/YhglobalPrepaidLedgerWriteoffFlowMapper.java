...
public interface YhglobalPrepaidLedgerWriteoffFlowMapper extends BaseMapper {
    @Insert({
            "insert into ${tablePrefix}_yhglobal_prepaid_ledger_writeoff_flow (flowId, flowCode, ",
            "projectId, ",
    ...
    @Select({
            ...
            "transferPattern, differenceAmountAdjustPattern",
            "from ${tablePrefix}_yhglobal_prepaid_ledger_writeoff_flow",
            "where flowId = #{flowId,jdbcType=BIGINT}"
    })
    YhglobalPrepaidLedgerWriteoffFlow selectById(@Param("tablePrefix")String tablePrefix,@Param("flowId") Long flowId);

    @Update({
            "update ${tablePrefix}_yhglobal_prepaid_ledger_writeoff_flow",
    ...
    int updateById(@Param("tablePrefix")String tablePrefix, YhglobalPrepaidLedgerWriteoffFlow record);
}
