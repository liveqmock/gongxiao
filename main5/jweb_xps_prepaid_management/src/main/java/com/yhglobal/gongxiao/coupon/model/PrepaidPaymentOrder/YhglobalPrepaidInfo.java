 ...
 * @author 王帅
 */
public class YhglobalPrepaidInfo implements Serializable{
    ...
    public String getSettlementTypeString() {
        return settlementTypeString;
    }

    public void setSettlementTypeString(String settlementTypeString) {
        this.settlementTypeString = settlementTypeString;
    }
