...
public class YhglobalCouponRecordSqlProvider {
    ...
    public String searchByToReceiveCouponIdAndFlowNo(@Param("tablePrefix")String tablePrefix,
                                                     @Param("toReceiveCouponId") Long toReceiveCouponId,
    ...
    public String searchCouponConfirm(@Param("tablePrefix")String tablePrefix,
        ...
        return new SQL() {{
            SELECT("flowNo,MIN(philipDocumentNo),MIN(confirmCurrencyCode) AS confirmCurrencyCode,SUM(confirmAmount) AS confirmAmount," +
