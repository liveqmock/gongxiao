 ...
 * @author : liukai
 */
public class PrepaidChannel implements Serializable{
    private  static Logger  logger = LoggerFactory.getLogger(PrepaidChannel.class);
